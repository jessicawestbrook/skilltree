...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <div className="flex gap-8 -mx-4 sm:-mx-6 lg:-mx-8">
        {/* Main Content */}
        <div className="flex-1 pl-4 sm:pl-6 lg:pl-8 pr-4 sm:pr-6 lg:pr-8 space-y-8">
        ...
        <aside className="hidden lg:block w-96 pr-4 sm:pr-6 lg:pr-8">
