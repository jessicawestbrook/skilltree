...
import { setupSpellingTables, checkTableExists } from '../utils/setupSpellingTables'
import { loadSpellingData } from '../utils/loadSpellingData'
...
export default function SpellingSetupPage() {
  ...
  const checkExistingTable = async () => {
    ...
    if (!exists) {
      const result = await setupSpellingTables()
      if (result.sql) {
