...
import { loadSpellingBeeData, checkSpellingBeeData } from '../utils/loadSpellingBeeData'

export default function AdminSpellingBeePage() {
  ...
  const handleCheckData = async () => {
    const data = await checkSpellingBeeData()
    if (data) {
      setCurrentData(data)
