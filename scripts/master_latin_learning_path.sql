...
COMMENT ON TABLE user_learning_path_progress IS 'Tracks user progress through learning paths';-- Create complete Henle Latin learning path with all 5 textbooks
